...
BOOST_AUTO_TEST_CASE(inherited_constructors)
{
	...
	map<string, EdgeNames> expectedCreationEdges = {
		...
		{"E", {
			{"Entry", "constructor of C"},
			{"constructor of C", "function C.inrC()"},
			{"constructor of C", "function E.inrE()"},
			{"constructor of C", "function free()"},
			{"function C.inrC()", "function free()"},
		...
		{"F", {
			...
			{"constructor of D", "function E.inrE()"},
			{"constructor of D", "function F.inrF()"},
			{"function C.inrC()", "function free()"},
			{"function E.inrE()", "function free()"},
...
BOOST_AUTO_TEST_CASE(inheritance_specifiers)
{
	unique_ptr<CompilerStack> compilerStack = parseAndAnalyzeContracts(R"(
		...
		contract E {
			...
			constructor (uint, uint, uint) {}
		}

		contract F is D, E(free(), E.e, C.f()) {
			constructor (uint) D(free(), C.f()) {}
		}
	)"s);
	tuple<CallGraphMap, CallGraphMap> graphs = collectGraphs(*compilerStack);
	...
	map<string, EdgeNames> expectedCreationEdges = {
		...
		{"F", {
			...
			{"constructor of C", "constructor of D"},
			{"constructor of C", "function free()"},
			{"constructor of D", "constructor of E"},
			{"constructor of D", "function free()"},
			{"constructor of E", "function C.f()"},
			{"constructor of E", "function free()"},
			{"constructor of E", "constructor of F"},
			{"constructor of F", "function C.f()"},
			{"constructor of F", "function free()"},
		}},
	};
...
BOOST_AUTO_TEST_CASE(diamond_inheritance)
{
	...
	map<string, EdgeNames> expectedCreationEdges = {
		...
		{"D", {
			...
			{"Entry", "function fVarC()"},
			{"constructor of C", "constructor of D"},
			{"constructor of C", "function fD()"},
			{"constructor of C", "function fVarD()"},
		}},
		{"E", {
			{"Entry", "constructor of C"},
			{"Entry", "function fVarC()"},
			{"constructor of C", "constructor of E"},
			{"constructor of C", "function fVarE()"},
		}},
		{"F", {
			{"Entry", "constructor of C"},
			{"Entry", "function fVarC()"},
			...
			{"constructor of C", "function fVarD()"},
			{"constructor of D", "constructor of E"},
			{"constructor of D", "function fVarE()"},
			{"constructor of E", "constructor of F"},
			{"constructor of E", "function fFD()"},
			{"constructor of E", "function fVarF()"},
